...
class App
{
     ...
     * Add GET router
     *
     * @param  string          $pattern  The router URI pattern
     * @param  callable|string $callable The router callback routine
     *
    ...
    /**
     * Add router for any HTTP method
     *
     * @param  string $pattern The router URI pattern
     * @param  callable|string $callable The router callback routine
     *
    ...
    /**
     * Add router with multiple methods
     *
    ...
    /**
     * Add a router that sends an HTTP redirect
     *
     * @param string              $from
     ...
     * Add a router group
     *
     * This method accepts a router pattern and a callback. All router
    ...
    /**
     * Pull router info for a request with a bad method to decide whether to
    ...
    /**
     * Perform a sub-request from within an application router
     *
     * This method allows you to prepare and initiate a sub-request, run within
     * the context of the current request. This WILL NOT issue a remote HTTP
     * request. Instead, it will router the provided URL, method, headers,
    ...
    /**
     * Dispatch the router to find the router. Prepare the router for use.
     *
     * @param ServerRequestInterface $request
    ...
    protected function dispatchRouterAndPrepareRoute(ServerRequestInterface $request, RouterInterface $router)
    {
        ...
        if ($routeInfo[0] === Dispatcher::FOUND) {
            ...
            // add router to the request's attributes in case a middleware or handler needs access to the router
