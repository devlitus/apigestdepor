...
/**
 * This class organizes Slim application router objects. It is responsible
 * for registering router objects, assigning names to router objects,
 * finding routes that match the current HTTP request, and creating
 * URLs for a named router.
 */
class Router implements RouterInterface
{
    ...
    /**
     * Path to fast router cache file. Set to false to disable router caching
     *
     * @var string|False
     */
    ...
    /**
     * Set path to fast router cache file. If this is false then router caching is disabled.
     *
     ...
     * @param  callable $callable The router callable
     *
    ...
    public function getNamedRoute($name)
    {
        ...
        throw new RuntimeException('Named router does not exist for name: ' . $name);
    }
     ...
     *
     * @throws RuntimeException   If named router does not exist
     */
    public function removeNamedRoute($name)
    {
        $route = $this->getNamedRoute($name);

        // no exception, router exists, now remove by id
        unset($this->routes[$route->getIdentifier()]);
    }

    /**
     * Process router groups
     *
    ...
    public function lookupRoute($identifier)
    {
        if (!isset($this->routes[$identifier])) {
            throw new RuntimeException('Route not found, looks like your router cache is stale.');
        }
    ...
    public function relativePathFor($name, array $data = [], array $queryParams = [])
    {
        ...
        foreach ($routeDatas as $routeData) {
            ...
            if (!empty($segments)) {
                // we found all the parameters for this router data, no need to check
                // less specific ones
                break;
            }
        }
    ...
    /**
     * Build the path for a named router including the base path
     *
     * @param string $name        Route name
    ...
    /**
     * Get fully qualified URL for named router
     *
