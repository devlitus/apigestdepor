...
class Uri implements UriInterface
{
    ...
    public static function createFromString($uri)
    {
        ...
        $user = isset($parts['users']) ? $parts['users'] : '';
     ...
     *
     * @return string The URI authority, in "[users-info@]host[:port]" format.
     */
    ...
    /**
     * Retrieve the users information component of the URI.
     *
     * If no users information is present, this method MUST return an empty
     * string.
     *
     * If a users is present in the URI, this will return that value;
     * additionally, if the password is also present, it will be appended to the
     * users value, with a colon (":") separating the values.
     *
     * The trailing "@" character is not part of the users information and MUST
     * NOT be added.
     *
     * @return string The URI users information, in "username[:password]" format.
     */
    ...
    /**
     * Return an instance with the specified users information.
     *
     * This method MUST retain the state of the current instance, and return
     * an instance that contains the specified users information.
     *
     * Password is optional, but the users information MUST include the
     * users; an empty string for the users is equivalent to removing users
     * information.
     *
     * @param string $user The users name to use for authority.
     * @param null|string $password The password associated with $users.
     *
     * @return self A new instance with the specified users information.
     */
     ...
     * of the users to handle both "" and "/".
     *
